...
const MedicineForm = () => {
    ...
    const {
        ...
        bind: bindprescriptionNumber,
        reset: resetprescriptionNumber,
    } = useInput('');
    ...
    return (
        <form onSubmit={handleSubmit}>
            <fieldset className="field-label">
                <input id={'name'} type="text" name="name" {...bindname} />
            ...
            <fieldset className="field-label">
                <input id={'description'} type="text" name="description" {...binddescription} />
            ...
            <fieldset className="field-label">
                <input id={'date'} type="date" name="date" {...binddate} />
            ...
            <fieldset className="field-label">
                <input id={'doctor'} type="text" name="doctor" {...binddoctor} />
            ...
            <fieldset className="field-label">
                <input id={'pharmacy'} type="text" name="pharmacy" {...bindpharmacy} />
            ...
            <fieldset className="field-label">
                <input id={'size'} type="text" name="size" {...bindsize} />
            ...
            <fieldset className="field-label">
                <input id={'refillLength'} type="text" name="refillLength" {...bindrefillLength} />
            ...
            <fieldset className="field-label">
                <input type="submit" name="submit" value={'ADD Your Meds'} />
