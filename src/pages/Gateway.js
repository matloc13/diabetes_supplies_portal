...
const Gateway = () => {
    ...
    return (
        <main className="profile-gateway">
            {formType === 'welcome' && (
                <section>
                    <GatewayNav handleClick={handleClick} formType={formType} />
                    <h3>Welcome to Medical supplies/devices manager</h3>
                    <p>
                        an inventory manager for your medical package arrivals and id numbers for
                        each package. I use it to try my diabetes activities. changing my insulin
                        pump site and my cgm site.
                    </p>
                </section>
            )}
            {formType === 'login' && (
